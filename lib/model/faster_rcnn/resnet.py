...
model_details = {
    50: {"path": 'data/pretrained_model/resnet50_caffe.pth', "fn": resnet50},
    101: {"path": 'data/pretrained_model/resnet101_caffe.pth', "fn": resnet101},
}


class resnet(_fasterRCNN):
    def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
        self.model_path = model_details[num_layers]["path"]
